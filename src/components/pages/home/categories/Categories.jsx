        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-6'>
            <div className='bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition duration-300'>
              ...
              <h3 className='font-bold text-gray-900 mb-1'>Fiction</h3>
              <p className='text-sm text-gray-600'>1,240 Books</p>
            </div>
            ...
            <div className='bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition duration-300'>
              ...
              <h3 className='font-bold text-gray-900 mb-1'>Science</h3>
              <p className='text-sm text-gray-600'>856 Books</p>
            </div>
            ...
            <div className='bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition duration-300'>
              ...
              <h3 className='font-bold text-gray-900 mb-1'>Fantasy</h3>
              <p className='text-sm text-gray-600'>932 Books</p>
            </div>
            ...
            <div className='bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition duration-300'>
              ...
              <p className='text-sm text-gray-600'>1,025 Books</p>
            </div>
          </div>
        </div>
      </section>
